            ...
            <motion.div className='relative max-w-2xl border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10' initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }}>
                ...
                <div className='p-5'>
                    ...
                    <div className='flex items-center justify-between mt-4'>
                        ...
                        <a className='inline-flex items-center gap-1 font-medium cursor-pointer hover-animation'>View Project <img src='assets/arrow-up.svg' className='size-4' href={"href"}/></a>
                    </div>
                </div>
            </motion.div>
        </div>
