        ...
        <section className="c-space section-spacing">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
                ...
                <div className="flex items-end grid-default-color grid-1">
                    ...
                    <div className="z-10">
                        <p className="headtext">Hi, I'm Rifatul Islam</p>
                        <p className="subtext">Over the last 4 years, i developed my frontend and backend skills to delivar responsive and dynamic software web applications.</p>
                    </div>
                ...
                <div className="grid-special-color grid-4">
                    <div className="flex flex-col items-center justify-center gap-4 size-full">
                        <p className="text-center headtext">Do You Want To Start A Project Togather?</p>
                        <CopyEmailButton />
                    </div>
                </div>
                {/* Grid 5 */}
                <div className="grid-default-color grid-5">
                    <div className ="z-10 w-[50%]">
                        ...
                        <p className="subtext">I specialize in a variety of languages, frameworks, and tools that allow me to build robust and scalable web applications.</p>
                    </div>
